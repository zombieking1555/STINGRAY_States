...
public class TunerConstants {
    ...
    public static CommandSwerveDrivetrain createDrivetrain() {
        SubsystemStatusManager.addSubsystem("Swerve", 
        new TalonFX(kFrontLeftDriveMotorId), 
        new TalonFX(kFrontLeftSteerMotorId), 
        new TalonFX(kFrontRightDriveMotorId), 
        new TalonFX(kFrontRightSteerMotorId), 
        new TalonFX(kBackLeftDriveMotorId), 
        new TalonFX(kBackLeftSteerMotorId), 
        new TalonFX(kBackRightDriveMotorId), 
        new TalonFX(kBackRightSteerMotorId),
        new CANcoder(kFrontLeftEncoderId),
        new CANcoder(kFrontRightEncoderId),
        new CANcoder(kBackLeftEncoderId),
        new CANcoder(kBackRightDriveMotorId));

        DeviceTempReporter.addDevices(
        new TalonFX(kFrontLeftDriveMotorId), 
        new TalonFX(kFrontLeftSteerMotorId), 
        new TalonFX(kFrontRightDriveMotorId), 
        new TalonFX(kFrontRightSteerMotorId), 
